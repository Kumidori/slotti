...
const en = {
  ...
  'plan.title': 'Plan Floor {floor}',
  'plan.subtitle': 'Pick one room per level. Path locks in once you start.',
  'plan.start': 'Start Floor',
  'plan.pickAll': 'Pick all rooms first',
  'plan.boss': 'Boss',
  ...
  'ability.slash.name': 'Slash',
  'ability.slash.desc': 'Costs 1 spin · 10 sword damage (+ 2 per Sharp Blade)',
...
const de = {
  ...
  'plan.title': 'Plane Etage {floor}',
  'plan.subtitle': 'Wähle einen Raum pro Ebene. Pfad steht fest, sobald du startest.',
  'plan.start': 'Etage starten',
  'plan.pickAll': 'Erst alle Räume wählen',
  'plan.boss': 'Boss',
  ...
  'ability.slash.name': 'Hieb',
  'ability.slash.desc': 'Kostet 1 Dreh · 10 Schwert-Schaden (+ 2 pro Scharfer Klinge)',
...
const bg = {
  ...
  'plan.title': 'Планирай етаж {floor}',
  'plan.subtitle': 'Избери стая за всеки етап. Пътят се заключва при старт.',
  'plan.start': 'Старт',
  'plan.pickAll': 'Първо избери всички стаи',
  'plan.boss': 'Бос',
  ...
  'ability.slash.name': 'Удар',
  'ability.slash.desc': 'Струва 1 дреш · 10 меч-щети (+ 2 на остро острие)',
